...
const Manager = () => {
  ...
  useEffect(() => {
    const passwords = localStorage.getItem("passwords"); // Change from "password" to "passwords"
    if (passwords) {
  ...
  const savePassword = () => {
    ...
    localStorage.setItem("passwords", JSON.stringify(updatedArray)); // Make sure "passwords" is used
  ...
  const deletePassword = (id) => {
    if (confirm("Do you really want to delete this password?")) {
      ...
      setpasswordArray(updatedArray);
      localStorage.setItem("passwords", JSON.stringify(updatedArray)); // Keep "passwords" key
                ...
                {passwordArray.map((item, index) => {
                  return (
                    <tr key={index}>
                      ...
                      <td className="py-2 border border-white text-center">
                        <div className="flex items-center justify-center">
                          <span className="mr-1">{item.password}</span>
                          <img
